...
module.exports = function(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('extension.hcmobile.runjsorhtml', function (uri) {
        const panel = vscode.window.createWebviewPanel(
            'hc_mobile_grid', // viewType
            "配置Cloud Grid手机内网ip地址", // 视图标题
